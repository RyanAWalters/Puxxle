...
if [ -f "C:\Program Files\Epic Games\UE_4.15\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "C:\Program Files\Epic Games\UE_4.15\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
